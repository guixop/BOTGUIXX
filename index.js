		...
		try {
			...
			mess = {
				...
				only: {
					...
					ownerG: '🎃 Este comando só pode ser usado pelo propietario do grupo! 🎃',
					ownerB: '🖥️ Este comando só pode ser usado pelo proprietário do bot! 🖥️',
        ...
        case 'promote':
				...
				case 'toimg':
					...
					exec(`ffmpeg -i ${media} ${ran}`, (err) => {
						fs.unlinkSync(media)
						if (err) return reply('❌ Falha ao converter adesivos em imagens(VERIFIQUE SE VOCÊ FEZ O PRECEDIMENTO CORREROTO!) ❌')
